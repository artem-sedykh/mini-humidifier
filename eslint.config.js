...
module.exports = [
  ...
  {
    // The bench and its scenarios (#257): node, and they report to the
    // terminal. Browser globals as well, because the argument of
    // `page.evaluate` is source that is serialised and run inside the page -
    // `document` there is the dashboard's, not this process's.
